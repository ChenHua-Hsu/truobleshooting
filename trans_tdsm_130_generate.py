...
#                trained_model_name = 'training_20240408_1350_output/ckpt_tmp_299.pth'
                trained_model_name = '/eos/home-c/chenhua/copy_tdsm_encoder_sweep16/training_result/training_20240817_0912_output/ckpt_tmp_199.pth'
                output_directory = generate(files_list_, load_filename=trained_model_name, device=device)
        ...
        if switches_>>3 & trigger:
            ...
            save_name = os.path.join(output_directory,'input-dists.png')
            fig.savefig(save_name)
...
#             Converter_.plot_re(r_gen,E_gen,z_gen)
            ...
            wandb.log({"summary" : wandb.Image(os.path.join(output_directory, 'calo_score', 'reference_average_shower_dataset-2.png'))})
            ...
            wandb.log({"summary":  wandb.Image(os.path.join(output_directory, 'calo-score', 'voxel-energy-dataset-2.png'))})
