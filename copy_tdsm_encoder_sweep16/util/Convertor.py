...
class Convertor:
    ...
    def get_re(self, particle='electron',xml_bin='dataset_generation_code/binning_dataset_2.xml'):
      r, E,z = self.dataset.r_e_get(particle, xml_bin, pad_value=self.padding_value)
      return r,E,z
    
    def plot_re(self,r_gen,E_gen,z_gen,particle='electron',xml_bin='dataset_generation_code/binning_dataset_2.xml'):
       self.dataset.r_e_plot_e(particle, xml_bin, r_gen=r_gen, E_gen= E_gen,z_gen=z_gen,pad_value=self.padding_value)
