...
if __name__ == '__main__':
  ...
  parser.add_argument('--config_file', type=str, default = '/eos/user/c/chenhua/copy_tdsm_encoder_sweep16/configs/full_dataset.yml',help = 'configuration file for wandb')
  parser.add_argument('--python_cfg', type=str, default = 'trans_tdsm_130.py', help = 'python file to run the code')
